        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-purple-300/70">
              Paste your TraceX key to unlock encrypted spans.
            </p>
          </div>
          <Card className="p-6 bg-gradient-to-br from-purple-950/50 to-blue-950/50 border-purple-500/30 backdrop-blur-sm mb-6">
            <p className="text-sm text-purple-200/80">
              Keys stay in this browser session only. Import yours below to continue.
            </p>
          </Card>
